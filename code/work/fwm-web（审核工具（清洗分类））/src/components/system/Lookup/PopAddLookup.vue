      ...
      >
        ...
        >
          <div class="lookOne">
            ...
            <div class="abox">
              <span class="abox-lableName"><span style="color:white">*</span>项目描述：</span>
              <div class="input-box">
                <el-input
                  maxlength="20"
            ...
            <div class="abox">
              <span class="abox-lableName"><span style="color:white">*</span>拓展字段1：</span>
              <div class="input-box">
                <el-input
                  maxlength="20"
                  v-model="list.expandValue1"
                  placeholder="请填写拓展字段1"
                ></el-input>
              </div>
            </div>
            <div class="abox">
              <span class="abox-lableName"><span style="color:white">*</span>拓展字段2：</span>
              <div class="input-box">
                <el-input
                  maxlength="20"
                  v-model="list.expandValue2"
                  placeholder="请填写拓展字段2"
                ></el-input>
              </div>
            </div>
            <div class="abox">
              <span class="abox-lableName"><span style="color:white">*</span>拓展字段3：</span>
              <div class="input-box">
                <el-input
                  maxlength="20"
                  v-model="list.expandValue3"
                  placeholder="请填写拓展字段3"
                ></el-input>
              </div>
            </div>
            <div class="abox">
              <span class="abox-lableName"><span style="color:white">*</span>拓展字段4：</span>
              <div class="input-box">
                <el-input
                  maxlength="20"
                  v-model="list.expandValue4"
                  placeholder="请填写拓展字段4"
                ></el-input>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    //新建
    addLookupChild() {
      this.list.lookupCode = this.$parent.lookupCodeName;
      let vm = this;
      let data = this.list;
      api

        .post(`./manage/service/lookupitem/insert`, data)
    ...
    updateLookupChild() {
      ...
      let data = this.list;
      api
        .post(`./manage/service/lookupitem/update`, data)
        .then(function(response) {
          if (response.status == 200) {
            vm.resetData();
            vm.$parent.deployLookup();
