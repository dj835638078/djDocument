      ...
      >
        ...
        >
          <div class="popBox-lookup">
            ...
            <div class="abox">
              <span class="abox-lableName">区域编号：</span>
              <div class="input-box">
                <el-input
                  maxlength="20"
                  v-model="regionCode"
...
export default {
  ...
  methods: {
    ...
    deployLookup() {
      let vm = this;
      let data = {
        autoCode: this.lookupCodeName,
        itemCode: this.itemCode,
        itemName: this.itemName,
        itemDesc: this.itemDesc,
        regionCode: this.regionCode,
        childrenAutoCode: this.childrenAutoCode
      };

      api
        .post(
          `./manage/service/autoLookupItem/page?currentPage=${
            this.currentPage
    ...
    newLookup() {
      ...
      this.listChild.childrenAutoCode = "";
    ...
    edit(val) {
      ...
      this.listChild.childrenAutoCode = val.childrenAutoCode;
      this.judgePopLookup = true;
    },
    //删除一个
    removeOne(val) {
    ...
    removeLookupChild() {
      ...
      let data = arr;
      api
        .post(`./manage/service/autoLookupItem/delete`, data)
        .then(function(response) {
          if (response.status == 200) {
            vm.$message({
              showClose: true,
