      ...
      var PDFViewerApplication = {
        ...
        _initializeViewerComponents: function _initializeViewerComponents() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this2.findController = new _pdf_find_controller.PDFFindController({
        ...
        load: function load(pdfDocument, scale) {
          ...
          pdfDocument.getDownloadInfo().then(function () {
            ...
            firstPagePromise.then(function () {
              _this6.eventBus.dispatch('documentload', {
                source: _this6
              });
            });
          });
          ...
          Promise.all([onePageRendered, _ui_utils.animationStarted]).then(function () {
            pdfDocument.getOutline().then(function (outline) {
              _this6.pdfOutlineViewer.render({
                outline: outline
              });
            });
            pdfDocument.getAttachments().then(function (attachments) {
              _this6.pdfAttachmentViewer.render({
          ...
          value: function scrollThumbnailIntoView(page) {
            ...
            if (numVisibleThumbs > 0) {
              ...
              if (page <= first || page >= last) {
                (0, _ui_utils.scrollIntoView)(thumbnail, {
