      ...
      <el-form>
        <div class="basicInfo">
          ...
          <div class="itemGroup">
            ...
            <div class="content">
              {{ tools.setExamineResult(detailObj.processResult) }}
            </div>
          </div>
          <div class="itemGroup">
          ...
          <div class="itemGroup">
            ...
            <div class="content">
              {{
                detailObj.processResult == "pass"
                  ? tools.setErrorType(detailObj.errorType)
                  : tools.setErrorRefuseType(detailObj.errorType)
              }}
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getDetail() {
      ...
      vm.api
        .get(
          `./complex/service/appealEntry/findInfo?checkId=${
            vm.$route.params.id
          }`
        )
        .then(response => {
    ...
    submitBtn() {
      ...
      vm.api
        .post(`./complex/service/appealEntry/appeal`, data)
        .then(response => {
          if (response.status == 200) {
            vm.$router.go(-1);
          }
