      ...
      <div class="itemBox">
        ...
        <div class="itemContent">
          ...
          <div class="itemSingle">
            ...
            <!-- <el-input v-model="dealInfo.rowkey" disabled></el-input> -->
            <div class="el-input">
              {{ tools.setVideoErrorLevel(dealInfo.errorLevel) }}
            </div>
          </div>
          <div class="itemSingle">
            <span>错误原因：</span>
            <!-- <el-input v-model="dealInfo.rowkey" disabled></el-input> -->
            <div class="el-input">{{ dealInfo.errorReason }}</div>
          </div>
          <div class="itemSingle">
            <span>错误备注：</span>
            <!-- <el-input v-model="dealInfo.rowkey" disabled></el-input> -->
            <div class="el-input">{{ dealInfo.errorRemark }}</div>
          </div>
        </div>
      </div>
      <div class="itemBox">
        ...
        <div class="itemContent">
          ...
          <div class="itemSingle">
            <span>截图：</span>
            <div class="imgBox">
              <img v-if="dealInfo.fId" :src="tools.downImg(dealInfo.fId)" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="itemContent">
          <div class="itemSingle">
            ...
            <div class="imgBox">
              <el-radio-group
                v-model="conclusion"
                v-if="$route.name == 'todoDetailVideo'"
              >
              ...
              <el-radio-group
                v-model="conclusion"
                v-if="$route.name == 'doneDetailVideo'"
                disabled
              >
                <el-radio :label="1">同意</el-radio>
                <el-radio :label="2">不同意</el-radio>
...
export default {
  ...
  methods: {
    //返回上一层
    goBack() {
      if (this.$route.name == "doneDetailVideo") {
        this.$router.push({
          name: "todoList",
          params: {
            type: 1
      ...
      vm.api
        ...
        .then(response => {
          if (response.status == 200) {
            ...
            if (vm.$route.name == "doneDetailVideo") {
