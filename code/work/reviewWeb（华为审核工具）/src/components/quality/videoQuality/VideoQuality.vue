...
export default {
  ...
  methods: {
    ...
    query() {
      ...
      api
        .post(
          `./manage/service/videoCheck/checkItems?currentPage=${this.currentPage}&pageSize=${this.pageSize}`,
          data
        )
    ...
    inquiry() {
      ...
      api
        .post(
          `./manage/service/videoCheck/findPage?currentPage=${this.currentPage}&pageSize=${this.pageSize}`,
          data
        )
        .then(function(response) {
          if (response.status == 200) {
    ...
    decideOne() {
      if (this.dataType1) {
        ...
        api
          .get(
            `./manage/service/channelLookUp/findLookUps?type=1_2&level=2&code=${this.dataType1}`
          )
          .then(function(response) {
    ...
    decideTwo() {
      if (this.dataType2) {
        ...
        api
          .get(
            `./manage/service/channelLookUp/findLookUps?type=1_2&level=3&code=${this.dataType2}`
          )
          .then(function(response) {
