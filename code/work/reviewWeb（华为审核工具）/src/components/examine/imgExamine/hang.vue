  ...
  methods: {
    ...
    decide() {
      if (this.dataType1) {
        ...
        api
          .get(
            `./manage/service/channelLookUp/findLookUpsAssgin?type=1_1&level=2&code=${this.dataType1}`
          )
          .then(function(response) {
      ...
      if (this.dataType2) {
        ...
        api
          .get(
            `./manage/service/channelLookUp/findLookUpsAssgin?type=1_1&level=3&code=${this.dataType2}`
          )
          .then(function(response) {
    ...
    inquiry() {
      ...
      api
        .post(
          `./manage/service/graphics/query?currentPage=${this.currentPage}&pageSize=${this.pageSize}`,
          data
        )
        .then(function(response) {
