...
export default {
  ...
  methods: {
    ...
    query() {
      ...
      api
        .post(
          `./manage/service/videoClientCheck/checkItems?currentPage=${
            this.currentPage
    ...
    casual() {
      let data = {
        ...
        accountId: this.accountId,
        lastProcessAccount: this.processAccount
      };
      let vm = this;
      api
        .post(`./manage/service/videoClientCheck/add`, data)
        .then(function(response) {
          if (response.status == 200) {
            vm.currentPage = 1;
            vm.pageSize = 10;
    ...
    inquiry() {
      ...
      api
        .post(
          `./manage/service/videoClientCheck/findPage?currentPage=${
            this.currentPage
          }&pageSize=${this.pageSize}`,
          data
        )
    ...
    getoptions() {
      let vm = this;
      api
        .get(`./manage/service/channelLookUp/findLookUps?type=1_2&level=1`)
        .then(function(response) {
    ...
    decideOne() {
      if (this.dataType1) {
        ...
        api
          .get(
            `./manage/service/channelLookUp/findLookUps?type=1_2&level=2&code=${
              this.dataType1
            }`
          )
          .then(function(response) {
    ...
    decideTwo() {
      if (this.dataType2) {
        ...
        api
          .get(
            `./manage/service/channelLookUp/findLookUps?type=1_2&level=3&code=${
              this.dataType2
            }`
          )
          .then(function(response) {
