<template>
  <div class="washStory">
    ...
    <div class="content-box">
      <!-- 操作按钮 -->
      <div class="infoHeadBtn" v-if="$route.name != 'washCheck'">
        <div
          class="release"
          v-if="
        ...
        <div class="imgInfoOperate" v-if="$route.name != 'washCheck'">
          <div
        ...
        <div class="fileListBox">
          <template v-for="(item, index) in fileList">
            ...
            <div
              ...
              @mouseenter="mouEnterFile(item, index)"
              @mouseleave="mouOutFile()"
              v-if="$route.name == 'washCheck' && item.fileCount > 0"
            >
              <div class="fileImgBox">
                <img
                  src="../../../../assets/img/file.svg"
  ...
  methods: {
    ...
    operateBtnY() {
      ...
      if (this.operateFlag == "deleteOne") {
        ...
        if (vm.$route.name == "washCheck") {
          vm.operateItem(objFlag, "deleteMetariai");
        } else {
          vm.operateItem(arrFlag, "updateMetariaiFile");
        }
      }
      ...
      if (this.operateFlag == "submit") {
        vm.api
          ...
          .then(function(response) {
            if (response.status == 200) {
              vm.$router.push({ name: "checkWashList" });
            }
          })
          .catch(function(error) {});
      }
    ...
    getFileList(firstLoad) {
      ...
      if (this.$route.name == "washCheck") {
        urlFlag =
          "./manage/service/materiai/findImgfileGroup?checkingStatus=1&";
      }
      vm.api
        .get(urlFlag + "orderId=" + this.$route.params.id)
        .then(function(response) {
          if (response.status == 200) {
